...
const page = usePage();
const form = useForm({
    firstname: page.props.info.firstname,
    lastname: page.props.info.lastname,
    email: page.props.info.email,
    mobile: page.props.info.mobile,
    password: page.props.info.password,
});
const submit = () => {
    form.post('/updateUser', {
        onSuccess: () => {
                            ...
                            <div class="container-fluid m-0 p-0">
                                <div class="row m-0 p-0">
                                    ...
                                    <div class="col-md-4 p-2">
                                        ...
                                        <input id="email" v-model="form.email"  readonly class="form-control" type="email"/>
                                    </div>
